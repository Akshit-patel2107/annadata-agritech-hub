      ...
      <div className="glass mx-3 mt-3 rounded-2xl px-4 py-3 md:mx-6 md:px-6">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 md:flex md:justify-between">
          ...
          <nav className="hidden items-center gap-7 text-sm font-medium md:flex">
            <a href="#platform" className="hover:text-[color:var(--forest)] transition">Platform</a>
            <a href="#market" className="hover:text-[color:var(--forest)] transition">Marketplace</a>
            <a href="#manifesto" className="hover:text-[color:var(--forest)] transition">Manifesto</a>
            <a href="#access" className="hover:text-[color:var(--forest)] transition">Early Access</a>
          </nav>
          <a
            href="#access"
          ...
          >
            Get Early Access <ArrowUpRight className="size-4" />
          </a>
        </div>
      </div>
    </header>
    ...
    <section id="top" className="relative isolate grain">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pt-20 pb-24 md:pt-32 md:pb-40">
        ...
        <div className="animate-rise mt-10 flex flex-wrap gap-3" style={{ animationDelay: "0.4s" }}>
          ...
          >
            Join Early Access <ArrowUpRight className="size-4 transition group-hover:rotate-45" />
          </a>
          <a
            href="#platform"
